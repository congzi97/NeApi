        ...
        <Row type="flex">
            <i-col :span="spanLeft" class="layout-menu-left">
                ...
                <div v-if="false === loading">    
                        <i-menu active-name="1" width="auto" @on-select="menu_onSelect">
                ...
                <transition  name="custom-classes-transition"
                    ...
                    <div class="layout-header" v-if="false === loading">
                        <i-menu mode="horizontal" theme="primary" active-name="1" on-select="menu_onSelect">
                            ...
                            <div style="float:left;width: 70%;text-align: center;color:#fff;font-size: 1.2rem;line-height: 60px;">
                               版本V1.0
                            </div>
                            <div class="layout-nav" style="float: right;width: 20%;text-align:right;">
                                <menu-item name="1">
    ...
    var _vm =  new Vue({
        ...
        methods: {
            menu_onSelect : function(name){
                window.location.href='/base_'+name+'.php';
            },
